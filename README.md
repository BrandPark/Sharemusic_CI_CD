...
## 프로젝트 시작 계기
회사에서 실무를 해보면서 내가 코드를 짤 때 굉장히 생각이 많다는 것을 새삼 느꼈습니다.

**좋은 코드를 만들고 싶은 욕심에 비해 경험이 부족하여 무엇이 옳은지 판단을 못내리기 때문**에 딜레이가 생기는 것이었습니다. 

하나의 서비스를 처음부터 만들어보면서 고민했던 것들을 실제로 적용해 보면서 딜레이를 줄이고 싶어서 시작했습니다.
...
- Cloud Native하게 배포까지 이루어지도록 CI/CD 파이프 라인을 구축한다.
